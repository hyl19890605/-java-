...
<el-table-column prop="sex" label="上级部门" width="300" :formatter="formatSex" sortable>
</el-table-column>
<el-table-column prop="age" label="创建时间" width="450" sortable>
</el-table-column>
...
<el-dialog :title="editFormTtile" v-model="editFormVisible" :close-on-click-modal="false">
	<el-form :model="editForm" label-width="80px" :rules="editFormRules" ref="editForm">
		...
		<el-select v-model="editForm.name" placeholder="请选择性别">
...
<script>
	...
	export default {
        ...
        created(){
			$.ajax({
				url:this.api+'/sys/dept/treePage',
				method:'get',
				data:{},
			...
			$.ajax({
				url:this.api+'/sys/dept/treeList',
				method:'get',
				data:{},
				 beforeSend: function(xhr, settings) {
                                if (!csrfSafeMethod(settings.type) && !this.crossDomain) {
